...
import org.apache.flink.formats.parquet.vector.reader.*;
 ...
 */
public class ParquetSplitReaderUtilKamu {
    ...
    public static ColumnReader createColumnReader(
        ...
        switch (fieldType.getTypeRoot()) {
            ...
            case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
                if (type.asPrimitiveType().getPrimitiveTypeName() == PrimitiveType.PrimitiveTypeName.INT64) {
                    return new TimestampColumnReaderI64(
                            isUtcTimestamp,
                            descriptors.get(0),
    ...
    public static WritableColumnVector createWritableColumnVector(
        ...
        switch (fieldType.getTypeRoot()) {
            ...
            case TIMESTAMP_WITH_LOCAL_TIME_ZONE:
                checkArgument(
                        typeName == PrimitiveType.PrimitiveTypeName.INT96 || typeName == PrimitiveType.PrimitiveTypeName.INT64,
                        "Unexpected type: %s",
                        typeName);
