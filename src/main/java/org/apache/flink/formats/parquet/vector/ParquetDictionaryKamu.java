...
import static org.apache.flink.formats.parquet.vector.reader.TimestampColumnReaderI64.decodeInt64ToTimestamp;

/**
 * Parquet dictionary.
 */
public final class ParquetDictionaryKamu implements Dictionary {

    private org.apache.parquet.column.Dictionary dictionary;
    private final ColumnDescriptor descriptor;

    public ParquetDictionaryKamu(org.apache.parquet.column.Dictionary dictionary, ColumnDescriptor descriptor) {
