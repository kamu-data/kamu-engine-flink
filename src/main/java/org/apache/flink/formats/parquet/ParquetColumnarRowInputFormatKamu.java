...
// KAMU: Overridden purely for the sake of changes in ParquetVectorizedInputFormatKamu
public class ParquetColumnarRowInputFormatKamu<SplitT extends FileSourceSplit>
        extends ParquetVectorizedInputFormatKamu<RowData, SplitT>
     ...
     */
    public ParquetColumnarRowInputFormatKamu(
    ...
    /**
     * Create a partitioned {@link ParquetColumnarRowInputFormatKamu}, the partition columns can be
     * generated by {@link Path}.
     */
    public static <SplitT extends FileSourceSplit>
    ParquetColumnarRowInputFormatKamu<SplitT> createPartitionedFormat(
            Configuration hadoopConfig,
        ...
        return new ParquetColumnarRowInputFormatKamu<>(
                hadoopConfig,
                projectedRowType,
                producedTypeInfo,
                factory,
