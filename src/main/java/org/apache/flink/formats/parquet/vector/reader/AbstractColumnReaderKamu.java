...
import org.apache.flink.formats.parquet.vector.ParquetDictionaryKamu;
 ...
 */
public abstract class AbstractColumnReaderKamu<VECTOR extends WritableColumnVector>
    ...
    public AbstractColumnReaderKamu(ColumnDescriptor descriptor, PageReader pageReader)
            throws IOException {
        ...
        while (readNumber > 0) {
            ...
            if (isCurrentPageDictionaryEncoded) {
                ...
                if (vector.hasDictionary() || (rowId == 0 && supportLazyDecode())) {
                    ...
                    vector.setDictionary(new ParquetDictionaryKamu(dictionary, descriptor));
                } else {
