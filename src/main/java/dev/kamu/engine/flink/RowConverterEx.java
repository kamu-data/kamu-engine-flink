...
public class RowConverterEx extends GroupConverter implements ParentDataHolder {
    ...
    public RowConverterEx(MessageType messageType, TypeInformation<?> typeInfo) {
        this(messageType, typeInfo, null, 0);
    }

    public RowConverterEx(
    ...
    private static Converter createConverter(
        ...
        if (field.isPrimitive()) {
            return new RowConverterEx.RowPrimitiveConverter(field, parentDataHolder, fieldPos);
        } else if (typeInformation instanceof MapTypeInfo) {
            return new RowConverterEx.MapConverter(
            ...
            if (typeClass.equals(Character.class)) {
                return new RowConverterEx.ArrayConverter<Character>(
                        elementType,
                        Character.class,
                ...
                return new RowConverterEx.ArrayConverter<Boolean>(
                        elementType,
                        Boolean.class,
                ...
                return new RowConverterEx.ArrayConverter<Short>(
                        elementType,
                        Short.class,
                ...
                return new RowConverterEx.ArrayConverter<Integer>(
                        elementType,
                        Integer.class,
                ...
                return new RowConverterEx.ArrayConverter<Long>(
                        elementType,
                        Long.class,
                ...
                return new RowConverterEx.ArrayConverter<Double>(
                        elementType,
                        Double.class,
                ...
                return new RowConverterEx.ArrayConverter<String>(
                        elementType,
                        String.class,
                ...
                return new RowConverterEx.ArrayConverter<BigDecimal>(
                        elementType,
                        BigDecimal.class,
            ...
            return new RowConverterEx.ArrayConverter<Row>(
                    elementType,
                    Row.class,
            ...
            return new RowConverterEx((GroupType) field, typeInformation, parentDataHolder, fieldPos);
        }
    ...
    static class ArrayConverter<T> extends GroupConverter implements ParentDataHolder {
        ...
        ArrayConverter(
            ...
            if (isElementType(elementType, elementTypeInfo)) {
                ...
                elementConverter =
                        new RowConverterEx.ArrayConverter.ArrayElementConverter(groupType, elementClass, elementTypeInfo, this);
            }
        }
    ...
    static class MapConverter extends GroupConverter {
        ...
        MapConverter(
            ...
            this.keyValueConverter =
                    new RowConverterEx.MapConverter.MapKeyValueConverter((GroupType) type.getType(0), typeInfo);
        }
    ...
    static Converter createArrayElementConverter(
        ...
        if (elementClass.equals(Row.class)) {
            ...
            return new RowConverterEx.RowPrimitiveConverter(elementType, holder, 0);
        }
    }
