 ...
 * - not to emit max watermark on close
 * - not to restore already processed splits from checkpoint
 */
public class CustomFileReaderOperator<OUT> extends AbstractStreamOperator<OUT>
    ...
    public CustomFileReaderOperator(FileInputFormat<OUT> format) {
        ...
        if (context.isRestored()) {
            ...
            if (restoredReaderState == null) {
                ...
                //if (LOG.isDebugEnabled()) {
                    LOG.info("{} (taskIdx={}) restored {}.", getClass().getSimpleName(), subtaskIdx, restoredReaderState);
                //}
            }
        } else {
