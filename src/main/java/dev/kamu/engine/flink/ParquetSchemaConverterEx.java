...
public class ParquetSchemaConverterEx {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apache.flink.formats.parquet.utils.ParquetSchemaConverter.class);
