 ...
 */
@PublicEvolving
public class UnboundedFromElementsFunction<T> implements SourceFunction<T>, CheckpointedFunction {
    ...
    public UnboundedFromElementsFunction(TypeSerializer<T> serializer, T... elements) throws IOException {
        this(serializer, Arrays.asList(elements));
    }

    public UnboundedFromElementsFunction(TypeSerializer<T> serializer, Iterable<T> elements) throws IOException {
    ...
    protected void markIdle() throws Exception {
